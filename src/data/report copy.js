...
const nonFnb = [
    {
        ...
        subcategories: [
            ...
            },
            {
                ...
                lineItems: [
                    {
                        lineItem: "Staff uniform/attire is not soiled.",
        ...
        subcategories: [
            {
                ...
                lineItems: [
                    ...
                    {
                        lineItem:"Fixtures and fittings including shelves, cupboards and drawers are clean and dry and in a good state.",
                    ...
                    {
                        lineItem:"Equipment is clean, in good condition and serviced.",
                    ...
                    {
                        lineItem: "Floor within customer areas is clean and dry.",
                         
                    },
                    {
                        lineItem: "Waste is properly managed and disposed:\n-Waste bins are not over-filled.\n-Waste Management: Proper disposal of general waste.",
...
//covid safe management checklist
const csmc = [
    {
        category: "Part 1: Safe Management Measures for Front-of-house",
        lineItems: [
            {
                lineItem: "SafeEntry has been implemented for dine-in customers.",
                 
            },
            {
                lineItem: "Temperature screening is conducted for customers of outlets that are located outside of institution’s temperature screening zone.",
                 
            },
            {
                lineItem: "Table and seating arrangement adheres to the one-metre spacing between tables or groups. Where tables/seats are fixed, tables/seats should be marked out, ensuring at least one-metre spacing.",
                 
            },
            {
                lineItem: "Queue is demarcated to ensure at least one-metre spacing between customers such as entrances and cashier counters (e.g. through floor markers).",
                 
            },
            {
                lineItem: "Staff to ensure customers maintain safe distance of one-metre when queuing and seated.",
                 
            },
            {
                lineItem: "Staff to ensure customers wear a mask at all times, unless eating or drinking.",
                 
            },
            {
                lineItem: "Hand sanitizers are placed at high touch areas (i.e. tray return, collection point, outlet entrance/exit).",
                 
            },
            {
                lineItem: "Outlet promotes use of cashless payment modes.",
                 
            }
        ]
    },
    {
        category: "Part 2: Staff Hygiene & Safe Management Measures",
        lineItems: [
            {
                lineItem: "All staff to wear a mask at all times, unless eating or drinking.",
                 
            },
            {
                lineItem: "Mask worn by staff is in the correct manner (i.e. cover nose and mouth, no hanging of mask under the chin/neck).",
                 
            },
            {
                lineItem: "All staff to record their temperature daily.",
                 
            },
            {
                lineItem: "Staff to maintain safe distance of one-metre (where possible) and not congregate, including at common areas, and during break/meal times.",
                 
            },
            {
                lineItem: "Check with supervisor that all staff record SafeEntry check-in and check-out (Note: Supervisor is accountable for adherence)",
