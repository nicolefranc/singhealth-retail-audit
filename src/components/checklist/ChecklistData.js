...
export const dataCOVID = {
    data1:[
        ...
        'Queue is demarcated to ensure at least one-metre spacing between customers such as entrances and cashier counters (e.g. through floor markers).',
        ...
        'Hand sanitizers are placed at high touch areas (i.e. tray return, collection point, outlet entrance/exit).',
        'Outlet promotes use of cashless payment modes.',
    ],
    data2: [
        'All staff to wear a mask at all times, unless eating or drinking.',
        'Mask worn by staff is in the correct manner (i.e. cover nose and mouth, no hanging of mask under the chin/neck).',
