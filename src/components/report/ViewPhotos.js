                ...
                report.images.map((item, index) => {
                    return (
                        <Collapse.Panel key={index}
                            header={<h3 className="font-semibold text-lg">Name of Line Item</h3>} showArrow={false}>
                            ...
                            <div className="overflow-x-scroll overflow-y-hidden whitespace-nowrap mt-4">
                                <div className="w-full inline-block">
                                    ...
                                    { item.rectifications ? <Image.PreviewGroup>{ item.rectifications.map((image, index) => {
